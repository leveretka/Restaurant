...
<html>
    ...
    <body>
        ...
        <h1 style="alignment-baseline: central; text-align: center"><fmt:message key="ord_for_confirm" bundle="${lang}"/></h1>
...
<div class="wrapper">
            <table>
                <c:forEach var="order" items="${sessionScope.notconfirmed}">
                <tr>
                    ...
                    <th width="100px" style="text-align: center"><fmt:message key="customer" bundle="${lang}"/></th>
                    <th width="100px" style="text-align: center"><fmt:message key="confirm" bundle="${lang}"/></th>
                </tr>
                    <tr>
                        ...
                        <td width="150px" style="text-align: center">${order.customer.id}</td>
...
<!--        <br>
        <br>
        <form style="text-align:center" action="controller" method="post">
            <input type="hidden" name="pageName" value="confirm" />
            <input type="submit" name="send" value="ua"/>
            <input type="submit" name="send" value="en"/>
        </form>-->
